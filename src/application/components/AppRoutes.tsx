...
export const isLocalHost = [subdomain1, subdomain2].includes('localhost') || [window.location.hostname].includes('192.168.31.62');
export const isWallet = (localApp === 'wallet' && isLocalHost) || [subdomain1, subdomain2].includes('wallet') || true;
