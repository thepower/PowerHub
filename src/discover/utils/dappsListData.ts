...
export const dappsListData: DappsItemType[] = [
  {
    ...
    card: {
      ...
      description: 'Five thousand exciting hours of crazy shooter with a mixture of RPG and strategy. ' +
        'You can choose both the dark side and the light side. Moreover, you can change sides as the ',
      fullDescription: 'game progresses. As in life, this will require certain actions, depending on them, ' +
